  ...
  return (
    <Link to={`/react/post/${id}`}>
      <div class="lg:max-w-full lg:flex mt-5 w-full">
        ...
        <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-[#1A1A1B] rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal  w-[500px]">
          <div className="mb-8">
